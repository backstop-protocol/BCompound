...
export interface ComptrollerKovanContract
  extends Truffle.Contract<ComptrollerKovanInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ComptrollerKovanInstance>;
}
...
export interface ComptrollerKovanInstance extends Truffle.ContractInstance {
  _addCompMarkets: {
