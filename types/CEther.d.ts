...
export interface CEtherContract extends Truffle.Contract<CEtherInstance> {
  "new"(
    comptroller_: string,
...
export interface CEtherInstance extends Truffle.ContractInstance {
  _acceptAdmin: {
