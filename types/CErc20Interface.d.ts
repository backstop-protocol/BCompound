...
export interface CErc20InterfaceContract
  extends Truffle.Contract<CErc20InterfaceInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<CErc20InterfaceInstance>;
}
...
export interface CErc20InterfaceInstance extends Truffle.ContractInstance {
  _acceptAdmin: {
