...
export interface AbsBTokenContract extends Truffle.Contract<AbsBTokenInstance> {
  "new"(
    _registry: string,
    _cToken: string,
    meta?: Truffle.TransactionDetails
  ): Promise<AbsBTokenInstance>;
}

type AllEvents = never;

export interface AbsBTokenInstance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
