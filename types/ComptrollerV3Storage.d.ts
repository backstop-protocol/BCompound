...
export interface ComptrollerV3StorageContract
  extends Truffle.Contract<ComptrollerV3StorageInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<ComptrollerV3StorageInstance>;
}

type AllEvents = never;

export interface ComptrollerV3StorageInstance extends Truffle.ContractInstance {
