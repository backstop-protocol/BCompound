...
export interface IAvatarCErc20Contract
  extends Truffle.Contract<IAvatarCErc20Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IAvatarCErc20Instance>;
}

type AllEvents = never;

export interface IAvatarCErc20Instance extends Truffle.ContractInstance {
  approve: {
    (
      cToken: string,
      spender: string,
