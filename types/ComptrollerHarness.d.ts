...
export interface ComptrollerHarnessContract
  extends Truffle.Contract<ComptrollerHarnessInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ComptrollerHarnessInstance>;
}
...
export interface ComptrollerHarnessInstance extends Truffle.ContractInstance {
  _addCompMarkets: {
  ...
  blockNumber(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  getCompMarkets(txDetails?: Truffle.TransactionDetails): Promise<string[]>;
  ...
  harnessDistributeBorrowerComp: {
    (
      cToken: string,
      borrower: string,
      marketBorrowIndexMantissa: number | BN | string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<Truffle.TransactionResponse<AllEvents>>;
    call(
      cToken: string,
  ...
  harnessTransferComp: {
    (
      user: string,
      userAccrued: number | BN | string,
      threshold: number | BN | string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<Truffle.TransactionResponse<AllEvents>>;
    call(
      user: string,
  ...
  setCompAddress: {
    (compAddress_: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      compAddress_: string,
