...
export interface ICushionContract extends Truffle.Contract<ICushionInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ICushionInstance>;
}

type AllEvents = never;

export interface ICushionInstance extends Truffle.ContractInstance {
  canLiquidate: {
