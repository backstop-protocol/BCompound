...
export interface IAvatarContract extends Truffle.Contract<IAvatarInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IAvatarInstance>;
}

type AllEvents = never;

export interface IAvatarInstance extends Truffle.ContractInstance {
  approve: {
    (
      cToken: string,
      spender: string,
