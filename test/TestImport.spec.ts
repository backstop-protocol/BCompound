...
const FlashLoanImportWithFees: b.FlashLoanImportWithFeesContract = artifacts.require("FlashLoanImportWithFees");
  ...
  describe("BErc20", async () => {
    ...
    describe("import", async () => {
      ...
      beforeEach(async () => {
        ...
        expect(await cUSDT.borrow.call(FIVE_HUNDRED_USDT, { from: a.user1 })).to.be.bignumber.equal(ZERO);
        ...
        expect(await cETH.balanceOfUnderlying.call(a.user1)).to.be.bignumber.equal(
          ONE_ETH,
        );
        ...
        expect(await cUSDT.borrowBalanceCurrent.call(a.user1)).to.be.bignumber.equal(FIVE_HUNDRED_USDT);
