...
export default {
  ...
  networks: {
    remoteTesting: {
      url: `http://bphardhat-env.eba-raywersi.eu-central-1.elasticbeanstalk.com/`,
      // accounts: [
      //     "0xc5e8f61d1ab959b397eecc0a37a6517b8e67a0e7cf1f4bce5591f3ed80194444",
    ...
    remoteChainId1: {
      url: "http://bphardhat-chainid1.eu-central-1.elasticbeanstalk.com",
      //accounts: [0xcb49b99b00148d38c01410dc3259b978c45cf925bcc9a03e1cb7187d14c93095],
      timeout: 60000
    },
    hardhat: {
      forking: {
        url: "https://mainnet.infura.io/v3/516f946979bc4fa187edcdc164e0bac0",
        chainId: 1,
      },
      ...
      accounts: [
        ...
        {
          privateKey: "0xc5e8f61d1ab959b397eecc0a37a6517b8e67a0e7cf1f4bce5591f3ed80194444",
